        ...
        <div class="row mt-3">
          <div class="col-md-12">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="gre-fila-acciones">
                          ...
                          <button type="button" class="gre-icono gre-icono-enviar" data-ayuda="Reenviar al facturador" aria-label="Reenviar al facturador"
            ...
            <div class="gre-leyenda" x-show="hayGuias" x-cloak>
                ...
                <span class="gre-leyenda-item">
                  <span class="gre-icono gre-icono-enviar"><i class="fa fa-rotate-right"></i></span>
                  Reenviar al facturador
                </span>
                <span class="gre-leyenda-item">
                  <span class="gre-icono gre-icono-peligro"><i class="fa fa-ban"></i></span>
                  Anular
                </span>
            </div>
